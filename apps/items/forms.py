...
class ItemForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'generic_name', 'manufacturer', 'country_of_origin', 'sudan_agent', 'pack_size', 'dosage_form', 'strength',
        ...
        widgets = {
            ...
            'country_of_origin': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: الهند، مصر...'}),
            'sudan_agent': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'اسم الوكيل أو الموزع في السودان'}),
            'pack_size': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: علبة 30 قرص'}),
        ...
        labels = {
            ...
            'sudan_agent': 'الوكيل أو الموزع في السودان',
