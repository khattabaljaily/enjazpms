            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    return `
                        ...
                        <button type="button" class="cx-btn-ghost btn-sm btn-edit-user" data-id="${data}">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button type="button" class="cx-btn-ghost btn-sm btn-delete-user" data-id="${data}" data-name="${displayName}">
        ...
        const cardsHtml = rows.map(function (user) {
            ...
            return `<article class="cx-customer-card">
                ...
                <div class="cx-customer-card-actions">
                    ...
                    <button type="button" class="cxr-act cxr-act--del btn-delete-user" data-id="${user.id}" data-name="${name}" aria-label="حذف" title="حذف"><i class="fas fa-trash"></i></button>
                </div>
            </article>`;
        }).join('');
